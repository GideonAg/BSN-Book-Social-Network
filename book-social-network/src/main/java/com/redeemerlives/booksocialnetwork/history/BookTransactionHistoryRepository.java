...
public interface BookTransactionHistoryRepository extends JpaRepository<BookTransactionHistory, Integer> {
    ...
    @Query("""
            ...
            """)
    Optional<BookTransactionHistory> findBorrowedBook(Integer bookId, Integer userId);
    ...
    @Query("""
            ...
            AND history.returnApproved = false
            """)
    Optional<BookTransactionHistory> findBooksToApprove(Integer bookId, Integer userId);
}
